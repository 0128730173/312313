...
def read(d: int, m: int, index: dict, grad: bool = False):
    with torch.no_grad():
        ...
        layer.W2[index["D_i"], index["A_dist"]] = -1
        layer.W2[index["A_row"], index["A_dist"]] = 1
        layer.W2[index["A_dist"], index["A_dist"]] = -1
        layer.W2[index["M_bin_keep"], index["M_bin_keep"]] = -1
        layer.W2[index["bin_writen"], index["bin_writen"]] = -1
        layer.W2[index["bin_dfs"], index["bin_dfs"]] = -1
...
def mask_write(d: int, index: dict, grad: bool = False, s_idx: int = 0):
    with torch.no_grad():
        ...
        s_change = allocate_scratchpad(index, s_idx+1, 1)
...
def _update_mlp(d: int, index: dict, grad: bool = False, s_idx: int = 0):
    with torch.no_grad():
        ...
        layer.W1[index["bin_dfs"], index["bin_writen"]] = 1
        layer.W1[index["B_global"], index["bin_writen"]] = -1
        layer.W1[index["B_local"], index["bin_writen"]] = -1
